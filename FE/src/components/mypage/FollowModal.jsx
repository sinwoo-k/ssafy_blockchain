...
const FollowModal = ({ isOpen, onClose, title, users, onFollow, onUnfollow, isFollowingList, isLoading }) => {
      ...
      <div className="w-[380px] rounded-lg bg-[#1a1a1a] p-5 text-white shadow-xl max-h-[80vh] flex flex-col">
        ...
        {isLoading ? (
          <div className="flex justify-center items-center py-6">
            <div className="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-[#3cc3ec]"></div>
          </div>
        ) : (
          /* 사용자 목록 - 스크롤 가능 */
